...
namespace System.Security.Cryptography.Xml.Patched
{
    internal abstract class AncestralNamespaceContextManager
    {
        ...
        internal void LoadRenderedAttributes(SortedList attrRenderedList)
        {
            foreach (object attr in attrRenderedList.GetKeyList())
            {
                XmlAttribute attrib = (XmlAttribute)attr;
